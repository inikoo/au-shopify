...
window.table = function (url) {


    return {
        selectedOption: "", searchValue: '', page: 1, limit: 10, from: 0, to: 0, total: 0, items: null, isLoading: false, previousPage: 1, nextPage: null, lastPage: 0,
